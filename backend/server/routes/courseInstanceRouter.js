...
module.exports = app => {
  ...
  app.get('/api/course/assistant/student/:id', assistantController.findAssistantByStudentInstance) // Hakee opiskelijan assarin
  app.get('/api/course/assistant/teacher/:id', assistantController.findStudentsByTeacherInstance) // Hakee assarin opiskelijat
